   ...
   return (
      <div className='cakes'>
         <div className={`cakes__container ${visibleInfo ? 'cakes__container__visible' : ''}`}>
            ...
            <p className="cakes__container__type" onClick={() => setVisibleInfo(prev => !prev)}>{type}</p>
            <p className="cakes__container__price">{price}</p>
            <button className="cakes__container__button" onClick={() => setVisibleInfo(prev => !prev)}>{visibleInfo ? 'Vezi mai putin' : 'Vezi mai multe'}
            </button>
