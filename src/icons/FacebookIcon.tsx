...
export default ({ fill, width, height }: FacebookProps) => (


   <svg xmlns="http://www.w3.org/2000/svg" width={width ? width : '40'}
        height={height ? height : '40'} viewBox="0 0 48 48">
      <path fill={fill ? fill : '#000'} fillRule="evenodd"
